...
class Db
{
	...
	*/
	public function select(string $table, $fields = '*', array $where = [], string $order_by = '', string $order = '', int $limit = 0, int $limit_offset = 0, bool $load_array = false) : array
	{
	...
	* @return array
	*/
	public function selectWithKey(string $table, string $key, $fields = '*', array $where = [], string $order_by = '', string $order = '', int $limit = 0, int $limit_offset = 0, bool $load_array = false) : array
	{
		$this->sql->select($fields)->from($table)->where($where)->orderBy($order_by, $order)->limit($limit, $limit_offset);
	...
	*/
	public function selectRow(string $table, $fields = '*', array $where = [], bool $load_array = false)
	{
	...
	*/
	public function selectResult(string $table, $fields = '*', array $where = []) : ?string
	{
		$this->sql->select($fields)->from($table)->where($where)->limit(1);
	...
	*/
	public function selectById(string $table, int $id, $fields = '*', string $id_col = 'id', bool $load_array = false)
	{
	...
	*/
	public function selectByIds(string $table, array $ids, string $order_by = '', string $order = '', $fields = '*', string $id_col = 'id', bool $load_array = false) : array
	{
		if (!$ids) {
			return [];
		}
