...
class Db
{
	...
	*/
	protected $use_same_handle = true;

	/**
	* @var object $result The result generated by the last operation
	*/
	...
	* @param mixed $sql The query to execute. If empty, $this->sql is used (string,Sql)
	...
	* @param string $class_name The name of the class to instantiate when loading the objects
	* @return mixed Either an array or an object; null on failure
	*/
	...
	* @return mixed Returns an SplFixedArray with the rows as objects. If there are no rows, will return an empty array
	*/
	public function select(string $table, string $fields = '*', array $where = [], string $order_by = '', string $order = '', int $limit = 0, int $limit_offset = 0, bool $load_array = false) : array
	{
	...
	* @return array
	*/
	public function selectWithKey(string $table, string $key, string $fields = '*', array $where = [], string $order_by = '', string $order = '', int $limit = 0, int $limit_offset = 0, bool $load_array = false) : array
	{
		$this->sql->select($fields)->from($table)->where($where)->orderBy($order_by, $order)->limit($limit, $limit_offset);
	...
	* @return array
	*/
	public function selectArray(string $table, string $fields = '*', array $where = [], string $order_by = '', string $order = '', int $limit = 0, int $limit_offset = 0) : array
	{
		return $this->select($table, $fields, $where, $order_by, $order, $limit, $limit_offset, true);
	}

	/**
	* Similar with select_with_key but will return the data as array
	* @see Db::selectWithKey()
	* @return array
	*/
	public function selectArrayWithKey(string $table, string $key, string $fields = '*', array $where = [], string $order_by = '', string $order = '', int $limit = 0, int $limit_offset = 0) : array
	{
		$this->sql->select($fields)->from($table)->where($where)->orderBy($order_by, $order)->limit($limit, $limit_offset);
	...
	* @param array $where Where conditions in the format col => val
	* @param bool $load_array If true, will return the result as an array
	* @return mixed Returns the row as an object/array. If only a single column/field is requested will return it as a string; Returns null on failure
	*/
	public function selectRow(string $table, string $fields = '*', array $where = [], bool $load_array = false)
	{
	...
	* Returns the first column from the first row generated by a query
	* @param string $table The table name
	* @param string $fields The fields to select. If only a single column/field is requested will return it as a string instead of array/object
	* @param array $where Where conditions in the format col => val
	* @return string The first column from the first row
	*/
	public function selectResult(string $table, string $fields = '*', array $where = []) : ?string
	{
		$this->sql->select($fields)->from($table)->where($where)->limit(1);
	...
	*/
	public function selectById(string $table, string $id_col, int $id, string $fields = '*', bool $load_array = false)
	{
	...
	*/
	public function selectByIds(string $table, string $id_col, array $ids, string $order_by = '', string $order = '', string $fields = '*', bool $load_array = false) : array
	{
		if (!$ids) {
			return [];
		}
	...
	* @return int The number of rows
	*/
	public function countIds(string $table, string $id_col, array $ids) : int
	{
		if (!$ids) {
			return 0;
		}
	...
	* @return int The number of affected rows
	*/
	public function updateById(string $table, array $values, string $id_col, int $id) : int
	{
	...
	* @return int The number of affected rows
	*/
	public function updateByIds(string $table, array $values, string $id_col, array $ids) : int
	{
		if (!$ids) {
			return 0;
		}
	...
	* @return int The number of affected rows
	*/
	public function deleteById(string $table, string $id_col, int $id) : int
	{
	...
	* @return int The number of affected rows
	*/
	public function deleteByIds(string $table, string $id_col, array $ids) : int
	{
		if (!$ids) {
			return 0;
		}
