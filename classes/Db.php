...
class Db
{
	...
	* @param string $class_name The name of the class to instantiate when loading the objects
	* @return array|object Either an array or an object; null on failure
	*/
	...
	* @param array $where Where conditions in the format col => val
	* @param bool $load_array If true, will return the result as an array
	* @return array|object Returns the row as an object/array. If only a single column/field is requested will return it as a string; Returns null on failure
	*/
